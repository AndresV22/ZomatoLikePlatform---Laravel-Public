...
@if (Auth::guest() || Auth::user()-> role_id != 3)
	<font size="7"><p class="text-center">You cannot submit dishes.</p></font>
	<font size="4"><p class="text-center">Please log in to continue.</p></font>
@else
<hr>
<div class="content">
<div class="container">
  <form action='submitDish' method='post'>
    <div class="row">

        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
            <h4 class="tour-form-title">Creating a dish</h4>
        </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input name="description" type="text" placeholder="Write a description" class="form-control" required>
                  </div>
            </div>
        </div>
